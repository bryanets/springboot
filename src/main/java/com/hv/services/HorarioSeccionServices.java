...
public class HorarioSeccionServices {
	...
	public void registrar(HorarioSeccion hs) {
		repo.save(hs);
	}
	public void actualizar(HorarioSeccion hs) {
		repo.save(hs);
	}
	public void eliminarPorId(Integer cod) {
		repo.deleteById(cod);
	}
	public HorarioSeccion buscarPorId(Integer cod) {
		return repo.findById(cod).orElse(null);
	}
	public List<HorarioSeccion> listarTodo(){
		return repo.findAll();
	}
}
